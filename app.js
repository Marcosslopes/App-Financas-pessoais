...
class Bd {
	...
	getProximoId() {
		let proximoId = parseInt(localStorage.getItem('id')); // Garante que seja número
		return proximoId + 1;
	}
...
function cadastrarDespesa() {
    ...
    if(despesa.validarDados()){   
       bd.gravar(despesa)
        ...
        document.getElementById('modal_mensagem').innerHTML = 'Despesa registrada com sucesso!'
        ...
        document.getElementById('modal_mensagem').innerHTML = 'Preencha todos os campos corretamente'
